...
## Modulation de service pluri-annuel : cas du sous-service

- régulation possible sur deux ans
- proratisé sur RIPEC1 (mensualisée)
- capitalisation de 96 H max sur 3 ans (sous resp. dir. dép.)
- gain en transparence (cf. aussi corrélation de plus en plus forte avec ADE)
- possibilité de solder les heures mises en réserve si changement d'avis (mutation, etc.)

## Misc

- 2023-24 : régul paiement du suivi des étudiants salariés (PNS)
- examen des demandes de mutations prioritaires : si deux demandes (ou plus), le CAC ne peut se prononcer et les candidatures partent en CdS
- rapprochement de conjoint : valide dès que distance diminuée
- l'avis du labo & dép. est demandé *après* recueil des avis des rapporteurs (deux internes, deux externes) et *avant* CAC

**Citations du jour**

"Nous assumons nous-mêmes notre propre misère" (L. Fournier)

"Même au centre aéré on fait de la recherche" (L. Fournier, again)
